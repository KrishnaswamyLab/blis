...
#SBATCH --job-name=W1_scattering_coefs_traffic
#SBATCH --output=job_outputs/W1_scattering_coefs_%A_%a.txt
...
python calculate_scattering.py --scattering_type ${SCATTERING_TYPES[$SCATTERING_TYPE_INDEX]} --largest_scale 4 --highest_moment 3 --dataset traffic --sub_dataset ${SUB_DATASETS[$SUB_DATASET_INDEX]} --wavelet_type W1
